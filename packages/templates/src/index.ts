export type { TemplateDefinition } from './scaffold.js';
export { safeProjectSlug, viteScaffold } from './scaffold.js';
export type { FileTree, FileNode, DirectoryNode, MaterialisedFile } from './tree.js';
export { materialise, isFileNode } from './tree.js';

import type { TemplateDefinition } from './scaffold.js';
import { safeProjectSlug, viteScaffold } from './scaffold.js';
