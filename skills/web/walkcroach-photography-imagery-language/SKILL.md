---
name: walkcroach-photography-imagery-language
...
> WalkCroach Web skill — companion to `walkcroach-frontend-design`. Prefer Graphite Lumen tokens when the surface is WalkCroach-branded; customer brand tokens win for customer creatives. Pair with `walkcroach-image-gen` / Nova Canvas when generating imagery. Images may be downloaded, generated, or hyperlinked.
