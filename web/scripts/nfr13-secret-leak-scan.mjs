...
const FORBIDDEN_CANARIES = {
  ...
  /** Phase F — connector OAuth secrets must never ship in SPA bundles. */
  GOOGLE_OAUTH_CLIENT_SECRET: 'GOOG_NFR13_CANARY_CONNECTOR_SECRET',
  SLACK_OAUTH_CLIENT_SECRET: 'SLACK_NFR13_CANARY_CONNECTOR_SECRET',
  STRIPE_OAUTH_CLIENT_SECRET: 'STRIPE_NFR13_CANARY_CONNECTOR_SECRET',
};
